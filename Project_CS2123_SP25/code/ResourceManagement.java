...
public class ResourceManagement {
  ...
  private Double remainingBudget; /*
                                   * the budget left after purchases are made (should be 0 after the constructor
                                   * runs)
                                   */
...
class Department implements Comparable<Department> {
  ...
  public Department(String fileName) {
    /*
     * Open the fileName, create items based on the contents, and add those items to
     * itemsDesired
     */
   ...
   *
   * This function is to ensure the departments are sorted by the priority when
 ...
 * Item
 *
 * Stores the information associated with an Item which is desired by a
 * Department
 */
class Item {
